...
SWIFT_ENUM_FWD_DECL(NSInteger, AlarmType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, CameraStatus)
...
SWIFT_ENUM_FWD_DECL(NSInteger, DeviceModeType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, OrderType)
